...
class DeepFM:
    def __init__(self,opt):
        ...
        self.inputs,self.labels,self.feature_inds = process.get_data()
        # feature length
        ...
        self.field_cnt = len(process.fields_dict.keys())-2 #除去all_count feature2field  #特征总数
        self.opt = opt
...
def arg_parser(args):
    ...
    parser.add_argument('--train_log', type=str, help='', 
                        default='DeepFM_logs/graph')

    parser.add_argument('--save_path', type=str, help='', 
                        default='DeepFM_logs/checkpoint/model')
...
if  __name__ == "__main__":
    ...
    train_deepfm = DeepFM(opt)
    # train the model
    train_deepfm.train_model()